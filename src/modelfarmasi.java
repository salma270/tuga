public class modelfarmasi {
    ...
    public modelfarmasi(String i_code,String g_code, String i_supp, String i_barcode, String i_name, String i_qty, String i_qtymin, String i_unit, String i_size, String i_color, String i_brands, String i_kdsell, String i_sell, String i_status, String id, String I_cogs, String i_article){
        this.i_code = i_code;
        this.g_code = g_code;
        this.i_supp = i_supp;
        this.i_barcode = i_barcode;
